...
module.exports = class Boletos {
  ...
  gerarBoleto() {
    ...
    const { datas, valor, especieDocumento, numeroDocumento, linhaDigitavel, codigoBarraNumerico } = this.boleto;

    console.log('passed by here gerar-boleto');
    this.boletoInfo = Boleto.Boleto.novoBoleto()
      ...
      .comcodigoBarraNumerico(codigoBarraNumerico)
