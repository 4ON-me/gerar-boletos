...
const Bs2 = require('../../boleto/bancos/bs2');
...
var Boleto = (function () {
	...
	Boleto.prototype.comcodigoBarraNumerico= function (_codigoBarraNumerico) {
		this._codigoBarraNumerico = _codigoBarraNumerico;
		return this;
	};
	Boleto.prototype.getcodigoBarraNumerico= function () {
		return this._codigoBarraNumerico;
	};
	...
	Boleto.prototype.getLinhaDigitavelFormatado = function () {
		const linhaDigitavel = {linha: this.getLinhaDigitavel(), numeroDocumento: this.getNumeroDoDocumentoFormatado()};
